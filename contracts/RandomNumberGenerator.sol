...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the Jackpot lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == jackpotLottery, "Only JackpotLottery");
    ...
    /**
     * @notice Set the address for the JackpotLottery
     * @param _jackpotLottery: address of the Jackpot lottery
     */
    function setLotteryAddress(address _jackpotLottery) external onlyOwner {
        jackpotLottery = _jackpotLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IJackPotLottery(jackpotLottery).viewCurrentLotteryId();
    }
}